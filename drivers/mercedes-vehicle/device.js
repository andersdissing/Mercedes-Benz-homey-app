...
class MercedesVehicleDevice extends Homey.Device {
   ...
   */
  async onInit() {
    // Must run before any other logging - this class logs the VIN, GPS
    // coordinates and geofence zone names directly, and all of it can end
    // up in a user-submitted diagnostic report.
